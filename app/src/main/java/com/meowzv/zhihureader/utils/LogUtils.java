package com.meowzv.zhihureader.utils;

import android.content.Context;
import android.os.Environment;
import android.util.Log;

import com.meowzv.zhihureader.base.ZhihuReaderApplcation;
...
public class LogUtils {
    ...
    public static void init(Context context) { // 在Application中初始化
        LOG_FILE_PATH = Environment.getExternalStorageDirectory().getPath() + File.separator + ZhihuReaderApplcation.getInstance().getPackageName();
        LOG_FILE_NAME = "Log";
    }
